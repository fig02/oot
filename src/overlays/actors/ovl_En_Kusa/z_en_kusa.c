...
static InitChainEntry sInitChain[] = {
    ...
    ICHAIN_F32_DIV1000(minVelocityY, -17000, ICHAIN_CONTINUE), ICHAIN_F32(cullVolumeForward, 1200, ICHAIN_CONTINUE),
    ICHAIN_F32(cullVolumeScale, 100, ICHAIN_CONTINUE),         ICHAIN_F32(cullVolumeDownward, 120, ICHAIN_STOP),
};
