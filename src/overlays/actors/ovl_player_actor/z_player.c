...
// Can't use OsContPad because gz excludes the error code
typedef struct {
    /* 0x00 */ u16 button;
    /* 0x02 */ s8 stick_x;
    /* 0x03 */ s8 stick_y;
} CustomContPad; // size = 0x04

typedef struct {
    /* 0x00 */ CustomContPad contData;
    /* 0x04 */ u16 buttonDelta;
} GzMacroFrame;

typedef struct {
    /* 0x00 */ size_t size; // size of macro; total number of input frames
    /* 0x04 */ size_t seed_size;
    /* 0x08 */ CustomContPad start_input; // controller state at the start of recording; frame of reference for initial delta
    /* 0x0C */ GzMacroFrame input_frames[1]; // variable length, based on number of recorded frames
    // Some more fields here that aren't relevant for what I want to do..
} GzMacro;

u8 macro_data[] = {
	0x00, 0x00, 0x00, 0xD7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00,
	...
	0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x03, 0xCA, 0x00, 0x00,
	0x20, 0x00, 0x09, 0xAE, 0x00, 0x00, 0x20, 0x00, 0x07, 0xAD, 0x00, 0x00,
	0x20, 0x00, 0x05, 0xAC, 0x00, 0x00, 0x20, 0x00, 0x04, 0xAC, 0x00, 0x00,
	0x20, 0x00, 0x04, 0xAC, 0x00, 0x00, 0x20, 0x00, 0x04, 0xAC, 0x00, 0x00,
	0x20, 0x00, 0x04, 0xAC, 0x00, 0x00, 0x20, 0x00, 0x04, 0xAC, 0x00, 0x00,
	0x20, 0x00, 0x04, 0xAC, 0x00, 0x00, 0x20, 0x00, 0x04, 0xAC, 0x00, 0x00,
	0x20, 0x00, 0x04, 0xAC, 0x00, 0x00, 0x20, 0x00, 0x04, 0xAC, 0x00, 0x00,
	0x20, 0x00, 0x04, 0xAC, 0x00, 0x00, 0x20, 0x00, 0x04, 0xAC, 0x00, 0x00,
	...
	,
	...
	,
...
GzMacroPlayback sGzMacroPlayback;

void Player_StartGzMacro(Player* this, PlayState* play) {
    sGzMacroPlayback.enabled = true;
    sGzMacroPlayback.frame = 0;
    sGzMacroPlayback.macro = (GzMacro*)macro_data;
}

extern void PadUtils_UpdateRelXY(Input* input);

Input* Player_UpdateGzMacro(Player* this, PlayState* play) {
    Input* input = &sGzMacroPlayback.input;
    u32 playbackFrame = sGzMacroPlayback.frame;
    GzMacroFrame* curFrame;
    GzMacroFrame* prevFrame;
    CustomContPad* curContData;
    CustomContPad* prevContData;
    u16 curButtonDelta;

    curFrame = &sGzMacroPlayback.macro->input_frames[playbackFrame];
    prevFrame = &sGzMacroPlayback.macro->input_frames[playbackFrame - 1];

    curContData = &curFrame->contData;
    curButtonDelta = curFrame->buttonDelta;

    if (playbackFrame == 0) {
        prevContData = &sGzMacroPlayback.macro->start_input;
    } else {
        prevContData = &prevFrame->contData;
    }

    // cur
    *((CustomContPad*)&input->cur) = *curContData;

    // prev
    *((CustomContPad*)&input->prev) = *prevContData;

    // press
    input->press.button = (curContData->button & ~prevContData->button) | curButtonDelta;
    input->press.stick_x = curContData->stick_x - prevContData->stick_x;
    input->press.stick_y = curContData->stick_y - prevContData->stick_y;

    // rel
    input->rel.button = (~curContData->button & prevContData->button) | curButtonDelta;
    PadUtils_UpdateRelXY(input);

    if (playbackFrame >= sGzMacroPlayback.macro->size) {
        sGzMacroPlayback.enabled = false;
    }

    sGzMacroPlayback.frame++;

    return input;
}

void Player_StopGzMacro(Player* this, PlayState* play) {
    sGzMacroPlayback.enabled = false;
    sGzMacroPlayback.frame = 0;
}
...
void Player_UpdateCommon(Player* this, PlayState* play, Input* input) {
    ...
    if (CHECK_BTN_ALL(input->press.button, BTN_DUP)) {
        if (!sGzMacroPlayback.enabled) {
            Player_StartGzMacro(this, play);
        } else {
            Player_StopGzMacro(this, play);
        }
    }

    if (sGzMacroPlayback.enabled) {
        sControlInput = Player_UpdateGzMacro(this, play);
    } else {
        sControlInput = input;
    }
