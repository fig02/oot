            ...
            switch (this->actor.textId) {
                ...
                case 0x70F3:
                    if (this->skelAnime.animation != &D_060033B4) {
                        Actor_ChangeAnimation(&this->skelAnime, D_80A72050, 23);
                        func_800F5C64(0x922);
                    }
                    break;
            }
        ...
        case 2:
            switch (this->actor.textId) {
                ...
                case 0x70F3:
                    ...
                    Actor_ChangeAnimation(&this->skelAnime, D_80A72050, 17);
...
void func_80A70E34(EnHy* this, GlobalContext* globalCtx) {
    if (func_80A6F790(this, globalCtx) && func_80A6F6C0(this, globalCtx)) {
        ...
        Actor_ChangeAnimation(&this->skelAnime, D_80A72050, D_80A722D8[this->actor.params & 0x7F].unk_B);
...
void func_80A710F8(EnHy* this, GlobalContext* globalCtx) {
    if (this->unk_1E8.unk_00 != 0) {
        if (this->skelAnime.animation != &D_06000BFC) {
            Actor_ChangeAnimation(&this->skelAnime, D_80A72050, 26);
        }
    } else if (gSaveContext.eventInf[3] & 1) {
        if (this->skelAnime.animation != &D_06000FE4) {
            Actor_ChangeAnimation(&this->skelAnime, D_80A72050, 25);
        }
    } else if (this->skelAnime.animation != &D_060012E8) {
        Actor_ChangeAnimation(&this->skelAnime, D_80A72050, 24);
    }
}
...
void func_80A712C0(EnHy* this, GlobalContext* globalCtx) {
    if ((this->actor.xzDistToPlayer <= 100.0f) && (this->path != NULL)) {
        Actor_ChangeAnimation(&this->skelAnime, D_80A72050, 7);
...
void func_80A7134C(EnHy* this, GlobalContext* globalCtx) {
    ...
    if ((this->skelAnime.animation == &D_06002160) && (this->unk_1E8.unk_00 != 0)) {
        Actor_ChangeAnimation(&this->skelAnime, D_80A72050, 8);
    }
