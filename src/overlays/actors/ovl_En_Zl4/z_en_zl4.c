...
void EnZl4_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_21);
    ...
    if (gSaveContext.sceneSetupIndex >= 4) {
        Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_0);
...
s32 EnZl4_SetNextAnim(EnZl4* this, s32 nextAnim) {
    ...
    Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, nextAnim);
    return true;
}
    ...
    switch (this->talkState) {
        ...
        case 6:
            if ((func_8010BDBC(&globalCtx->msgCtx) == 5) && func_80106BC8(globalCtx)) {
                ...
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_22);
    ...
    switch (this->talkState) {
        ...
        case 3:
            if (!((func_8010BDBC(&globalCtx->msgCtx) == 4) && func_80106BC8(globalCtx))) {
                ...
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_28);
                this->blinkTimer = 0;
                ...
                EnZl4_SetCsCameraAngle(globalCtx, 2);
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_9);
        ...
        case 10:
            if ((func_8010BDBC(&globalCtx->msgCtx) == 5) && func_80106BC8(globalCtx)) {
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_5);
    ...
    switch (this->talkState) {
        ...
        case 1:
            if ((func_8010BDBC(&globalCtx->msgCtx) == 5) && func_80106BC8(globalCtx)) {
                ...
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_1);
                this->blinkTimer = 11;
                this->eyeExpression = ZL4_EYES_SQUINT;
                this->mouthExpression = ZL4_MOUTH_NEUTRAL;
                globalCtx->msgCtx.msgMode = 0x37;
        ...
        case 3:
            if ((func_8010BDBC(&globalCtx->msgCtx) == 5) && func_80106BC8(globalCtx)) {
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_16);
                this->blinkTimer = 0;
                this->eyeExpression = ZL4_EYES_NEUTRAL;
                globalCtx->msgCtx.msgMode = 0x37;
                this->talkState = 4;
        ...
        case 7:
            if ((func_8010BDBC(&globalCtx->msgCtx) == 5) && func_80106BC8(globalCtx)) {
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_6);
                this->mouthExpression = ZL4_MOUTH_HAPPY;
        ...
        case 10:
            if ((func_8010BDBC(&globalCtx->msgCtx) == 4) && func_80106BC8(globalCtx)) {
                if (globalCtx->msgCtx.choiceIndex == 0) {
                    ...
                    Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_33);
                    this->mouthExpression = ZL4_MOUTH_NEUTRAL;
                    globalCtx->msgCtx.msgMode = 0x37;
                    this->talkTimer2 = 0;
                    this->talkState = 15;
        ...
        case 11:
            if (DECR(this->talkTimer1) == 0) {
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_11);
                this->blinkTimer = 11;
...
s32 EnZl4_CsTellLegend(EnZl4* this, GlobalContext* globalCtx) {
    ...
    switch (this->talkState) {
        ...
        case 9:
            if ((func_8010BDBC(&globalCtx->msgCtx) == 5) && func_80106BC8(globalCtx)) {
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_26);
    ...
    switch (this->talkState) {
        ...
        case 2:
            if (globalCtx->csCtx.state != 0) {
                ...
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_30);
    ...
    switch (this->talkState) {
        ...
        case 4:
            if ((func_8010BDBC(&globalCtx->msgCtx) == 5) && func_80106BC8(globalCtx)) {
                ...
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_23);
                this->blinkTimer = 0;
                this->eyeExpression = ZL4_EYES_NEUTRAL;
                this->mouthExpression = ZL4_MOUTH_SURPRISED;
                globalCtx->msgCtx.msgMode = 0x37;
        ...
        case 7:
            if (!((func_8010BDBC(&globalCtx->msgCtx) == 4) && func_80106BC8(globalCtx))) {
                ...
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_31);
                this->blinkTimer = 11;
                this->eyeExpression = ZL4_EYES_SQUINT;
                this->mouthExpression = ZL4_MOUTH_HAPPY;
                ...
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_13);
                this->blinkTimer = 11;
        ...
        case 9:
            if ((func_8010BDBC(&globalCtx->msgCtx) == 5) && func_80106BC8(globalCtx)) {
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_14);
                globalCtx->msgCtx.msgMode = 0x37;
                this->talkState++;
            }
            break;
...
s32 EnZl4_CsMakePlan(EnZl4* this, GlobalContext* globalCtx) {
    switch (this->talkState) {
        case 0:
            Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_18);
            this->blinkTimer = 0;
            this->eyeExpression = ZL4_EYES_NEUTRAL;
            this->mouthExpression = ZL4_MOUTH_WORRIED;
        ...
        case 2:
            if ((func_8010BDBC(&globalCtx->msgCtx) == 5) && func_80106BC8(globalCtx)) {
                ...
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_19);
                this->blinkTimer = 0;
                this->eyeExpression = ZL4_EYES_NEUTRAL;
                this->mouthExpression = ZL4_MOUTH_SURPRISED;
        ...
        case 4:
            if ((func_8010BDBC(&globalCtx->msgCtx) == 5) && func_80106BC8(globalCtx)) {
                ...
                Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_7);
                this->blinkTimer = 0;
                this->eyeExpression = ZL4_EYES_NEUTRAL;
                this->mouthExpression = ZL4_MOUTH_NEUTRAL;
                this->talkState = 5;
...
void EnZl4_Cutscene(EnZl4* this, GlobalContext* globalCtx) {
    ...
    switch (this->csState) {
        case ZL4_CS_WAIT:
            ...
            break;
        case ZL4_CS_START:
            Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_3);
            this->blinkTimer = 0;
            this->eyeExpression = ZL4_EYES_NEUTRAL;
            this->mouthExpression = ZL4_MOUTH_SURPRISED;
            func_800F5C64(0x51);
...
void EnZl4_TheEnd(EnZl4* this, GlobalContext* globalCtx) {
    ...
    if (SkelAnime_Update(&this->skelAnime) && (this->skelAnime.animation == &gChildZeldaAnim_010DF8)) {
        Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, ZL4_ANIM_4);
    }
    if (EnZl4_InMovingAnim(this)) {
        EnZl4_SetMove(this, globalCtx);
    }
    ...
    if (npcAction != NULL) {
        ...
        if (this->lastAction != npcAction->action) {
            Actor_ChangeAnimation(&this->skelAnime, sAnimationEntries, animIndex[npcAction->action]);
