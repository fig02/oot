...
static InitChainEntry sInitChain[] = {
    ...
    ICHAIN_VEC3F_DIV1000(scale, 150, ICHAIN_CONTINUE),   ICHAIN_F32(cullVolumeForward, 900, ICHAIN_CONTINUE),
    ICHAIN_F32(cullVolumeScale, 100, ICHAIN_CONTINUE),   ICHAIN_F32(cullVolumeDownward, 800, ICHAIN_STOP),
};
