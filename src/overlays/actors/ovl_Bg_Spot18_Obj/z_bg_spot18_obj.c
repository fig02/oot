...
static InitChainEntry sInitChain1[] = {
    ...
    ICHAIN_F32(cullVolumeForward, 1400, ICHAIN_CONTINUE), ICHAIN_F32(cullVolumeScale, 500, ICHAIN_CONTINUE),
    ICHAIN_F32(cullVolumeDownward, 800, ICHAIN_STOP),
};
...
static InitChainEntry sInitChain2[] = {
    ...
    ICHAIN_F32(cullVolumeDownward, 700, ICHAIN_STOP),
};
