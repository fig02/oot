...
static InitChainEntry sInitChain[] = {
    ...
    ICHAIN_VEC3F_DIV1000(scale, 100, ICHAIN_CONTINUE),  ICHAIN_F32(cullVolumeForward, 1500, ICHAIN_CONTINUE),
    ICHAIN_F32(cullVolumeScale, 150, ICHAIN_CONTINUE),  ICHAIN_F32(cullVolumeDownward, 1500, ICHAIN_STOP),
};
