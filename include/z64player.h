...
typedef struct Player {
    ...
    /* 0x084F */ union {
        s8 actionVar1;
        s8 bottleCatchType; // Player_Action_SwingBottle: set depending on bottled actor and used to index sBottleCatchInfos
    ...
    /* 0x0850 */ union {
        ...
        s16 inWater; // Player_Action_SwingBottle: used to determine which bottle swing animation to use
